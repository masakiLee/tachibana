<template>
  <section class="section-menu bg-dark py-10 position-relative">
    ...
    <div
      class="menuTwo position-absolute"
      data-aos="fade-left"
      data-aos-delay="600"
    ...
    <div
      class="menuThree position-absolute"
      data-aos="fade-right"
      data-aos-delay="600"
      data-aos-duration="1000"
    >
    ...
    <div class="container">
      <div class="menu py-10 px-6 px-md-10 bg-darkTwo">
        <div class="row justify-content-center">
          <div class="col-12 col-lg-6">
            <div class="orangeBorder align-self-start mx-auto">
              <h2 class="menu-tips p-3 bg-dark position-absolute">美味菜單</h2>
            </div>
            <h3 class="menu-text text-center py-6 py-md-8">
